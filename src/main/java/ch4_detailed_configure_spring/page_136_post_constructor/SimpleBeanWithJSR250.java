package ch4_detailed_configure_spring.page_136_post_constructor;
...
public class SimpleBeanWithJSR250 {
    ...
    public static void main(String[] args) {
        ...
        ctx.load("classpath:META-INF/spring/ch4_detailed_configure_spring/page_136_post_constructor/app-context-annotation.xml");
        ctx.refresh();
