package ch4_detailed_configure_spring.page_158_property_editor;
...
public class PropertyEditorBean {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ctx.load("classpath:META-INF/spring/ch4_detailed_configure_spring/page_158_property_editor/app-context-xml.xml");
        ctx.refresh();
