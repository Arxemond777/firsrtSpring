package ch4_detailed_configure_spring.page_133_initializing_bean;
...
public class SimpleBeanWithInterface implements InitializingBean {
    ...
    public static void main(String[] args) {
        ...
        ctx.load("classpath:META-INF/spring/ch4_detailed_configure_spring/page_133_initializing_bean/app-context-xml.xml");
        ctx.refresh();
